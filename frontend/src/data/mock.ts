...
export const company: Company = {
  ...
  legalName: "Impact Solution Scandinavia AB",
  orgNumber: "556925-0516",
  vatNumber: "SE556925051601",
  founded: 2013,
  size: "7 employees",
  headcount: 7,
  hq: "Uppsala, Sweden",
  offices: ["Tiundagatan 59, 752 30 Uppsala"],
  website: "https://www.impactsolution.se",
  description:
    "Impact Solution Scandinavia AB is an Uppsala-based company focused on IT-based retail solutions and rental vending concepts for workplaces, gyms, golf courses and events.",
  leadership: [
    { name: "Bernt Tore Jonsson", title: "CEO" },
    { name: "Johan Michael Green", title: "Chair / board member" },
    { name: "Lars Erik Magnus Nilsson", title: "Board member" },
  ],
  industries: [
  ...
  references: [
    {
      client: "Companies and offices",
      scope: "Rental vending-machine concepts for workplace food, drink and energy products.",
      value: "not publicly disclosed",
      year: 2024,
      sector: "Workplaces",
    },
    {
      client: "Gyms, golf courses and event venues",
      scope: "Vending-machine rental for gyms, golf courses and event environments.",
      value: "not publicly disclosed",
      year: 2024,
  ...
  financialAssumptions: {
    revenueRange: "12.970–24.901 MSEK / year (2020–2024)",
    targetMargin: "0.1% operating margin 2024",
    maxContractSize: "Not publicly disclosed",
  },
  financials: [
  ...
  teamComposition: [
    { role: "Service and operations", count: 5, avgYears: 6 },
    { role: "Management and administration", count: 2, avgYears: 10 },
  ],
};
...
const evidence: Evidence[] = [
  ...
  // ---- Company profile evidence (seeded from Impact Solution Scandinavia AB) ----
  {
    id: "EVD-013",
    key: "COMPANY.IDENTITY.REGISTRATION",
    category: "Qualification Criteria",
    excerpt: "Impact Solution Scandinavia AB is registered under organization number 556925-0516.",
    source: "Impact Solution Scandinavia AB · company profile",
    page: 0,
    referencedBy: ["Compliance Officer"],
    kind: "company_profile",
    companyFieldPath: "orgNumber",
  },
  {
    id: "EVD-014",
    key: "COMPANY.REFERENCE.WORKPLACES",
    category: "Qualification Criteria",
    excerpt:
      "Companies and offices — rental vending-machine concepts for workplace food, drink and energy products.",
    source: "Impact Solution Scandinavia AB · company profile",
    page: 0,
    referencedBy: ["Win Strategist", "Delivery CFO"],
    kind: "company_profile",
    companyFieldPath: "references[0]",
  },
  {
    id: "EVD-015",
    ...
    category: "Qualification Criteria",
    excerpt:
      "Public financial history shows 2024 total revenue of 24.901 MSEK and result after financial net of -104 KSEK.",
    source: "Impact Solution Scandinavia AB · company profile",
    page: 0,
    referencedBy: ["Delivery CFO"],
    kind: "company_profile",
...
export const runs: Run[] = [
  {
    ...
    company: "Impact Solution Scandinavia AB",
  ...
  },
  {
    ...
    judge: {
      ...
      citedMemo:
        "Impact Solution should NOT bid. Healthcare domain depth is thin and the clinical safety classification adds delivery risk that is not offset by the contract value or strategic fit. Recommend re-evaluating only if a credible clinical partner can be secured.",
    },
  },
  {
    id: "run_e5f6a7b8",
    ...
    judge: {
      ...
      citedMemo:
        "Impact Solution should BID. Strong incumbent position from the 2023 contract, well-understood scope, and acceptable margins under the blended delivery model. Pricing pressure on senior rates is the main concern but is manageable with the proposed rate card.",
    },
  },
  {
    id: "run_9d3e2f1a",
