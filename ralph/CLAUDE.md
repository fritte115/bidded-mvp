...
- **Bidded Retrieval Contract**: `src/bidded/embeddings.py` owns the 1536-dimension provider/model contract and metadata shape; `src/bidded/retrieval` ranks chunks with keyword fallback or deterministic `MockEmbeddingAdapter` scoring metadata.
