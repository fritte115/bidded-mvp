...
- **Bidded Tender Registration Contract**: `src/bidded/documents/tender_registration.py` registers local PDFs using deterministic checksum storage paths, mocked Supabase Storage in tests, and demo-company metadata on tender/document rows.
